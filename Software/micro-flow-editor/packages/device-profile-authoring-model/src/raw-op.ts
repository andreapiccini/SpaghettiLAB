...
/** Fixed per-opcode compile — see each `Instruction` variant's doc comment in `instruction.ts` for the operand meaning this mirrors. */
export function toRawOp(instruction: Instruction): RawDeviceProfileOp {
  ...
  switch (instruction.op) {
    case "I2C_WRITE":
      return { ...base, opcode: DeviceProfileOpcode.I2C_WRITE, srcA: instruction.src };
    case "I2C_READ":
      return { ...base, opcode: DeviceProfileOpcode.I2C_READ, dst: instruction.dst, imm0: instruction.length };
    case "I2C_WRITE_READ":
      return { ...base, opcode: DeviceProfileOpcode.I2C_WRITE_READ, srcA: instruction.src, dst: instruction.dst, imm0: instruction.readLength };
    case "SPI_TRANSCEIVE":
      return { ...base, opcode: DeviceProfileOpcode.SPI_TRANSCEIVE, srcA: instruction.src, dst: instruction.dst, imm0: instruction.length };
    case "UART_WRITE":
      return { ...base, opcode: DeviceProfileOpcode.UART_WRITE, srcA: instruction.src };
    case "UART_READ_UNTIL":
      return { ...base, opcode: DeviceProfileOpcode.UART_READ_UNTIL, dst: instruction.dst, imm0: instruction.stopByte, imm1: instruction.maxLength };
    case "GPIO_GET":
      return { ...base, opcode: DeviceProfileOpcode.GPIO_GET, dst: instruction.dst };
    case "GPIO_SET":
      return { ...base, opcode: DeviceProfileOpcode.GPIO_SET, srcA: instruction.src };
    case "ADC_READ":
      return { ...base, opcode: DeviceProfileOpcode.ADC_READ, dst: instruction.dst };
    case "DELAY_BOUNDED":
    ...
    case "LOAD_CONST":
      return { ...base, opcode: DeviceProfileOpcode.LOAD_CONST, dst: instruction.dst, imm2: instruction.low, imm3: instruction.high };
    case "COPY_BYTES":
      return { ...base, opcode: DeviceProfileOpcode.COPY_BYTES, srcA: instruction.src, dst: instruction.dst };
    case "CONCAT":
