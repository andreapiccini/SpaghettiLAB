...
| | **D070 — Chiusura** | |
| ⬜ | [D070 — HOST_API freeze](tasks/D070-host-api-freeze.md) | |
| ⬜ | [D080 — Gate fase 1](tasks/D080-phase1-validation-gate.md) | |

## Dopo fase 1 (bozza D200 — grafica avanzata)

| Task | Tema |
|---|---|
| D200 | Scene model + binding editor (placement 2D) |
| D210 | Renderer `schematic` (schema macchina) |
| D220 | Renderer `top_down` (pianta / serra) |
...
| **Turnkey, ruoli, Support Grant** | Host + dashboard + Node-RED | [E010–E090](../roadmap/ecosystem-access-v1/README.md) |
