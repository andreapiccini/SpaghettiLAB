...
|---|---|---|
| `core.h` | Core boot/info/state | `subsys/core/README.md` |
| `port.h` | physical Port abstraction | `subsys/port/README.md` |
...
| `module_manager.h` | instance lifecycle/query/operations | `subsys/module_manager/README.md` |
| `discovery.h` | provider/policy/result contract | `subsys/discovery/README.md` |
| `driver_registry.h` | known-driver lookup | `subsys/driver_registry/README.md` |
| `data.h` | normalized value/event contract | `subsys/data/README.md` |
| `runtime.h` | user-program execution contract | `subsys/runtime/README.md` |
| `config.h` | desired-state snapshot/update | `subsys/config/README.md` |
| `communication.h` | external protocol boundary | `subsys/communication/README.md` |
| `power.h` | power resource/transition contract | `subsys/power/README.md` |
